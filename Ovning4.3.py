def lönen(hur_många_kronor):
    ...
    return"Det tar " +str(dagar)+ " dagar för att lönen ska bli 10miljoner kr!"  #Skriver ut hur många dagar det tar för lönen att bli 10miljoner kr
print(lönen(10000000))